...
local ts_util = require("snippets/shared/ts_util")
local in_mathzone = function()
  -- return vim.fn['vimtex#syntax#in_mathzone']() == 1
  return ts_util.in_mathzone()
end
...
s({trig = "mB", name = "Blackboard bold math font", snippetType = "autosnippet"},
    {
		f(function(_,snip) return snip.captures[1] end),
...
s({trig = "rd", name = "Superscript", snippetType = "autosnippet", wordTrig = false},
    {
        t("^{"), d(1,get_visual), t("}")
    },
    {condition = in_mathzone}
